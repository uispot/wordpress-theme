...
function hybrid_entry_comments_link_shortcode( $attr ) {
	...
	$attr = shortcode_atts( array( 'zero' => __( '0 条评论', 'hybrid-core' ), 'one' => __( '%1$s 条评论', 'hybrid-core' ), 'more' => __( '%1$s 条评论', 'hybrid-core' ), 'css_class' => 'comments-link', 'none' => '', 'before' => '', 'after' => '' ), $attr );
